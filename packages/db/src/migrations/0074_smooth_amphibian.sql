...
CREATE INDEX "IDX_contributor_champion_memberships_credits_due" ON "contributor_champion_memberships" USING btree ("credits_last_granted_at") WHERE "contributor_champion_memberships"."enrolled_tier" IS NOT NULL AND "contributor_champion_memberships"."credit_amount_microdollars" > 0;